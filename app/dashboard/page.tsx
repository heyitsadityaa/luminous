...
"
                ...
                <motion.div
                    initial={{ opacity: 0, x: 8 }}
                    animate={{ opacity: 1, x: 0 }}
                    transition={{ duration: 0.6, ease: "easeIn" }} className="md:col-span-4 md:row-span-6 grid gap-8 md:auto-rows-[90px] md:grid-cols-1"
                >
                    <motion.div
                        layout
                        transition={{
                        ...
                        className={isHovered ? "md:row-span-4" : "md:row-span-5 md:col-span-4"}
                    >
                    ...
                    <motion.div
                        ...
                        className={isHovered ? "md:row-span-3" : "md:row-span-2 md:col-span-4"}
